...
### Desafio 1: Recuperação de Layout
...
### Desafio 2: Geração de Contexto Relevante
...
### Desafio 3: Resolução de Ambiguidade
...
### Desafio 4: Recuperação Imediata de Valores
...
### Desafio 5: Aprendizado contínuo (não resolvido)
...
Para usar a aplicação gráfica, clique em "Carregar Fila (.json)..." e selecione seu fila.json. O "Diretório Base" será preenchido automaticamente. Você pode alterá-lo se os PDFs estiverem em outro lugar. Assumimos que todos os PDFs estão no mesmo diretório.
